    ...
    public static void solve(FastReader in, FastWriter out) throws IOException {
      // 	charMatrixInput(in, out);
        ...
        for(int i = 0; i < n;i++){
          ...
          if(a == b) continue;
          else if(a == 'S' && b == 'P')Acount++;
          else if(a == 'S' && b == 'R')Bcount++;
          else if(a == 'R' && b == 'P')Bcount++;
          else if(a == 'R' && b == 'S')Acount++;
          else if(a == 'P' && b == 'R')Acount++;
          else if(a == 'P' && b == 'S')Bcount++;
        }
        if(Acount > Bcount)out.println("0");
        else{
            out.println((int) Math.ceil(((float)Acount + Bcount + 1)/2) - Acount);
        } 
    }
}
